            ...
            <div className="flex items-center gap-4 px-6 py-4">
              <div className="relative flex-1 max-w-2xl">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-card border border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              ...
              >
                ...
                <span className="absolute -right-1 -top-1 w-4 h-4 text-[10px] bg-emerald-500 text-slate-950 rounded-full flex items-center justify-center">
                  3
                </span>
              </a>
